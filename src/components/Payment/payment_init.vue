  ...
  <div>
    <div class='bg-radius'>
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="top col-sm-12">
            <div class="insure-notice-box" @click="OnEnsure('B')">
              ...
              <div class="insure-check-content">使用活期性帳戶(手續費0元)</div>
            </div>
          </div>
        </div>
        <div class='border-bottom-line'></div>
        <!-- 查詢線上繳費發卡銀行 -->
        <div class='col-sm-12'>
          <div class='col-sm-6 insure-tips-text' @click='OnShowBanks()'>
            <img src='../../../static/img/insure-link.png' alt=''>查詢線上繳費發卡銀行
          </div>
          <div class='col-sm-6 insure-tips-text' @click='OnShowNotice()'>
            <img src='../../../static/img/insure-link.png' alt=''>注意事項
          </div>
        </div>
      </form>
    </div>
...
export default {
  ...
  methods: {
    ...
    OnShowNotice() {
      toggleModalShow(`<ul class=" insure-text-product font-label">
              <li>目前提供以下繳款方式：<BR>
                1.信用卡線上付款（限本人持有之VISA、MASTER、JCB、UCard信用卡）。<br>
                2.銀行帳戶線上轉帳付款(限本人持有之銀行帳戶)。
              </li>
              ...
              <li> 交易過程中，有發現任何錯誤訊息導致交易不成功者，請洽本公司電話服務中心0800-031-115。</li>
