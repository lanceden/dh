          ...
          <div class="top">
            ...
            <form class="form-bottom">
              <div class="form-group row">
                ...
                <div class="col-sm-12">
                  <div class="insure-input-block">活期性帳戶(電子化授權/全國繳費網)</div>
                </div>
              </div>
              <div class="col-sm-12">
