      ...
      <div class='bg-radius'>
        ...
        <div class='form-bottom'>
          <div class='form-group row'>
            ...
            <div class='col-sm-12 insured-sub insured2'>
              <select class='form-control data-input ChildCount' id='ChildCount1' name='ChildCount'>
            ...
            <div class='col-sm-12 insured-sub insured3'>
              <select class='form-control data-input ChildCount' id='ChildCount2' name='ChildCount'>
                <option value='1' selected='selected'>1位</option>
                <option value='2'>2位</option>
                <option value='3'>3位</option>
                <option value='4'>4位</option>
        ...
        <div class='form-group row'>
          <label for='' class='col-sm-12 col-form-label' name='title5'>您的旅程地點?</label>
          <div class='border-bottom-line col-sm-12'></div>
          <div class='top col-sm-12'>
            <div class='insure-notice-box radio-group'>
        ...
        <div class='col-sm-12 sub-box-2 TravelAim'>
          <div class='insure-tips-text' onclick='window.open(`https://www.mofa.gov.tw/News_FAQ.aspx?c=AD6908DFDDB62656&ampn=C1B19EF0ACDD3C91&ampsms=867F5398A49F758A`,`_blank`)'> <img src='../../../../static/img/insure-link.png' alt=''>申根地區國查詢
          </div>
        </div>
        <div class='form-group row'>
          <label for='' class='col-sm-12 col-form-label insure-label' id='title1'>您的旅程有幾天?</label>
          <div class='border-bottom-line col-sm-12'></div>
          <div class='col-sm-9'>
        ...
        <div class='form-group row'>
          ...
          <label for='' class='col-sm-12 col-form-label inperson-box'>本人</label>
          <div class='col-sm-12 inperson-box'>
            <select class='form-control data-input' id='TravelInsurance' name='TravelInsurance'>
              <option value=''>請選擇</option>
            </select>
          </div>
          <div class='border-bottom-line col-sm-12 child-box'></div>
          <label for='' class='col-sm-12 col-form-label child-box child'>1名子女各</label>
          <div class='col-sm-12 child-box'>
            <select class='form-control data-input' id='TravelInsuranceC' name='TravelInsuranceC'>
        ...
        <div class='form-group row'>
          ...
          <label for='' class='col-sm-12 col-form-label inperson-box'>本人</label>
          <div class='col-sm-12 inperson-box'>
            <select class='form-control data-input' id='TravelExtra' name='TravelExtra'>
          ...
          <label for='' class='col-sm-12 col-form-label child-box child'>1名子女各</label>
          <div class='col-sm-12 child-box'>
            <select class='form-control data-input' id='TravelExtraC' name='TravelExtraC'>
              <option value='0'>不投保</option>
            </select>
          </div>
        </div>
        <div class='form-group row TravelAim'>
          ...
          <label for='' class='col-sm-12 col-form-label inperson-box'>本人</label>
          <div class='col-sm-12 inperson-box'>
            <select class='form-control data-input' id='TravelOverseaExtra' name='TravelOverseaExtra'>
              <option value='0'>不投保</option>
            </select>
          </div>
          <div class='border-bottom-line col-sm-12 child-box'></div>
          <label for='' class='col-sm-12 col-form-label child-box child'>1名子女各</label>
          <div class='col-sm-12 child-box'>
            <select class='form-control data-input' id='TravelOverseaExtraC' name='TravelOverseaExtraC'>
              <option value='0'>不投保</option>
            </select>
          </div>
        </div>
...
const URLPREMIUMS = Url.Premiums
  ...
  methods: {
    ...
    Compute() {
      ...
      if (inputday === '') {
        $('#PayNum').html('NT$ 0')
        return false
      } else if (!IsWholeNumber(inputday)) { // 20171003 QC:1202 修正
        $('#PayNum').html('NT$ 0')
        // 旅遊區域
        var area = inputType === '1' ? '國內' : '國外'
        // 最高天數
        var highestday = inputType === '1' ? '90' : '180'
        toggleModalShow('請輸入旅遊天數，' + area + '最高' + highestday + '天')
        return false
      } else if (inputday > 90 && inputType === '1') {
        toggleModalShow('請輸入符合條件之天數')
        $('#PayNum').html('NT$ 0')
        return false
