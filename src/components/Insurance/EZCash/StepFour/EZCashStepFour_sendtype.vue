    ...
    <div class="top">
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block" v-show="cbOldAddr">{{GetEZCashPostData.InsAddress}}</div>
          </div>
...
export default {
  ...
  created() {
    this.tempAddr = this.GetEZCashPostData.InsAddress
  },
  computed: {
    ...mapGetters([
    ...
    OnCheck(type) {
      switch (type) {
        case 'cbOldAddr':
          ...
          this.GetEZCashPostData.InsAddress = this.tempAddr
          break
        case 'cbNewAddr':
          this.cbOldAddr = false
          this.cbNewAddr = true
          this.GetEZCashPostData.InsAddress = ''
          break
      }
    }
  }
