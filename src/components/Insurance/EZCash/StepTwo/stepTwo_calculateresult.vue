<template>
  <div class="bg-radius" v-show="GetEZCashPostData.mode_prem > 0">
    <div class="top">
      <div class="top-title">
      ...
      <div class="bg-money">
        <div class="col-sm-12">
          ...
          <div class="font-money"> NT$ {{GetEZCashPostData.mode_prem}}</div>
        ...
        <div class="bg-time">
          <div class="col-sm-12">
            ...
            <div class="font-label">{{GetEZCashPostData.po_issue_date_Name}}</div>
          </div>
        </div>
      </div>
    </div>
