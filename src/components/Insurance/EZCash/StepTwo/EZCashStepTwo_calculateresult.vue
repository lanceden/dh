      ...
      <div class="bg-radius">
        ...
        <div class="bg-money">
          <div class="col-sm-12">
            ...
            <div class="font-money">NT$ {{GetEZCashPostData.mode_prem|decimalComma}}</div>
            <div class="money-icon"><img src="../../../../../static/img/coins.png" /></div>
          </div>
        </div>
        <div class="border-bottom-line" v-show="GetEZCashPostData.qpoop_25_modx === '1'"></div>
        <form class="form-bottom" v-show="GetEZCashPostData.qpoop_25_modx === '1'">
          <div class="col-sm-12">
            <div class="insure-tips-text">
              選擇月繳續期保險費, 首次請繳付第一期與第二期保險費, 合計{{GetEZCashPostData.mode_prem|decimalComma}}元
            </div>
          </div>
        </form>
        <div class="border-bottom-line"></div>
        <div class="bg-time">
          <div class="col-sm-12">
            ...
            <div class="font-label text-red-i">自民國{{GetEZCashPostData.po_issue_date_Name}}起</div>
          </div>
        </div>
      </div>
