...
export default {
  ...
  created() {
    ...
    this.city3 = this.GetEZCashPostData.city3
    this.district3 = this.GetEZCashPostData.district3
    this.road3 = this.GetEZCashPostData.road3
  ...
  computed: {
    ...
    city3: {
      get() {
        return this.GetEZCashPostData.city3
      },
      set(value) {
    ...
    district3: {
      get() {
        return this.GetEZCashPostData.district3
      },
      set(value) {
        this.GetEZCashPostData.district3 = value
      }
    },
    road3: {
      get() {
    ...
    OnCheck(cbName) {
      switch (cbName) {
        ...
        case 'cbOldAddr':
          ...
          this.GetEZCashPostData.value_ind = '1'
          this.road3 = ''
          this.newMail = ''
          break
        case 'cbNewMail':
        ...
        case 'cbNewAddr':
          ...
          this.GetEZCashPostData.value_ind = '2'
          this.newMail = ''
          break
      }
    }
