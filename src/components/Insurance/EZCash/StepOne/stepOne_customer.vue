    ...
    <div class="top">
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <input type="text" class="form-control insure-input-block" v-model="GetEZCashPostData.client_names" disabled="disabled" />
          </div>
        </div>
        <div class="form-group row">
          <label for class="col-sm-12 col-form-label insure-label">被保險人出生年月日</label>
          <div class="col-sm-12">
            <input type="text" class="form-control insure-input-block" v-model="GetEZCashPostData.client_birth" disabled="disabled" />
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            ...
            v-model="GetEZCashPostData.client_rate_sex === 1 ? '男' : '女'" disabled="disabled" />
          </div>
        </div>
