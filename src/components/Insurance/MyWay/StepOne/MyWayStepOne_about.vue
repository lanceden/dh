...
export default {
  computed: {
    ...
    QusAns: {
      get() {
        return this.GetMyWayPostData.QusAns[1].Answar
      },
      set(value) {
        ...
        this.GetMyWayPostData.QusAns[1].Answar = !result
      }
    },
    QusAns2: {
      get() {
        return this.GetMyWayPostData.QusAns[2].Answar
      },
      set(value) {
        let result = value === 'true'
        if (value === '0') {
        ...
        this.GetMyWayPostData.QusAns[2].Answar = !result
      }
    },
    QusAns3: {
      get() {
        return this.GetMyWayPostData.QusAns[3].Answar
      },
      set(value) {
        let result = value === 'true'
        if (value === '0') {
        ...
        this.GetMyWayPostData.QusAns[3].Answar = !result
      }
    },
    QusAns4: {
      get() {
        return this.GetMyWayPostData.QusAns[4].Answar
      },
      set(value) {
        let result = value === 'true'
        if (value === '0') {
        ...
        this.GetMyWayPostData.QusAns[4].Answar = !result
      }
    },
    QusAns5: {
      get() {
        return this.GetMyWayPostData.QusAns[5].Answar
      },
      set(value) {
        let result = value === 'true'
        if (value === '0') {
        ...
        this.GetMyWayPostData.QusAns[5].Answar = !result
      }
    },
    QusAns6: {
      get() {
        return this.GetMyWayPostData.QusAns[6].Answar
      },
      set(value) {
        let result = value === 'true'
        if (value === '0') {
        ...
        this.GetMyWayPostData.QusAns[6].Answar = !result
      }
    },
    QusAns7: {
      get() {
        return this.GetMyWayPostData.QusAns[7].Answar
      },
      set(value) {
        let result = value === 'true'
        if (value === '0') {
        ...
        this.GetMyWayPostData.QusAns[7].Answar = !result
      }
    },
    QusAns8: {
      get() {
        return this.GetMyWayPostData.QusAns[8].Answar
      },
      set(value) {
        let result = value === 'true'
        if (value === '0') {
        ...
        this.GetMyWayPostData.QusAns[8].Answar = !result
      }
    },
    jobCode: {
      get() {
