    ...
    <div class="top">
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <input type="text" class="form-control insure-input" :value="GetMyWayPostData.phone_mobile">
          </div>
        </div>
        <div class="col-sm-12">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <input type="text" class="form-control insure-input" :value="GetMyWayPostData.phone_area">
            <input type="text" class="form-control insure-input" :value="GetMyWayPostData.phone_main">
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-12 col-form-label insure-label">同通訊地址</label>
          <div class="col-sm-12">
            <input type="text" class="form-control insure-input" :value="GetMyWayPostData.address1" :disabled="!GetContactCheckBox">
          </div>
  ...
  methods: {
    OnRegisterAddr() {
      ...
      if (!result) {
        ...
        /**
            // 戶籍地址
            var city2 = $("#MyWayRegisteredCity").val();
            var district = $("#MyWayRegisteredCounty").val();
            var zip2 = district.length > 0 ? district.substring(0, 3) : "";
            var district2 = district.length > 3 ? district.substring(3) : "";
            var road2 = $("#MyWayRegisteredRoad").val();
             */
      }
