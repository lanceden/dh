  ...
  <div class="bg-radius">
    ...
    <form class="form-bottom">
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <input type="text" class="form-control insure-input" v-model="GetHealthPostData.phone_mobile">
        </div>
      </div>
      <div class="col-sm-12">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <input type="text" class="form-control insure-input" v-model="GetHealthPostData.phone_area">
          <input type="text" class="form-control insure-input" v-model="GetHealthPostData.phone_main">
        </div>
      </div>
...
export default {
  computed: {
    ...
    address: {
      get() {
        return this.GetHealthPostData.address1
      },
      set(value) {
        console.log(value)
      }
