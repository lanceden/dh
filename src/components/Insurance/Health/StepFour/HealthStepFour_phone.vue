    ...
    OnCkech(phoneTime) {
      switch (phoneTime) {
        case 'visit_time1':
          ...
          this.GetHealthPostData.visit_time1 = this.visit_time1 ? '1' : '0'
          break
        case 'visit_time2':
          this.visit_time2 = !this.visit_time2
          this.GetHealthPostData.visit_time2 = this.visit_time2 ? '1' : '0'
          break
        case 'visit_time3':
          this.visit_time3 = !this.visit_time3
          this.GetHealthPostData.visit_time3 = this.visit_time3 ? '1' : '0'
          break
      }
    }
  }
