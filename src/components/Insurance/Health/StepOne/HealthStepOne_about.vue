<template>
  <div class="bg-radius">
    ...
    <form class="form-bottom">
      ...
      <div class="form-group row">
        <label class="col-sm-12 col-form-label insure-label">請問您是否已投保其他商業實支實付型醫療保險?</label>
        <div class="col-sm-12 insure-select-align">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12 insure-select-align">
          <select class="form-control data-input insure-select insure-input-block-edit" v-model="QusAns9">
            <option value="0">請選擇</option>
            <option value="true">是</option>
            <option value="false">否</option>
          </select>
        </div>
        <label class="col-sm-12 col-form-label insure-label" v-show="isShowAns9Error === true">親愛的客戶謝謝您的申購保險，因相關法規規定您的申請文件需另檢附相關證明文件。很抱歉您無法於本網站進行投保動作。煩請另洽新光人壽服務人員詢問相關保險商品購買事宜，造成您的不便我們深感抱歉，再次感謝您的惠顧。</label>
      </div>
      <!-- 投保健康險者請繼續填寫本項： -->
      <div class="form-group row">
        <label class="col-sm-12 col-form-label insure-label">投保健康險者請繼續填寫本項：</label>
        <label class="col-sm-12 col-form-label insure-label">(有任一者，請選擇“是”)</label>
        <div class="insure-notice-text">
          <ul class="insure-notice-text-ul">
        ...
        <div class="col-sm-12 insure-select-align">
          <select class="form-control data-input insure-select insure-input-block-edit" v-model="QusAns10">
            <option value="0">請選擇</option>
            <option value="true">是</option>
            <option value="false">否</option>
          </select>
        </div>
        <label class="col-sm-12 col-form-label insure-label" v-show="isShowAns10Error === true">親愛的客戶謝謝您的申購保險，因相關法規規定您的申請文件需另檢附相關證明文件。很抱歉您無法於本網站進行投保動作。煩請另洽新光人壽服務人員詢問相關保險商品購買事宜，造成您的不便我們深感抱歉，再次感謝您的惠顧。</label>
      </div>
    </form>
  </div>
</template>
  ...
  computed: {
    ...
    QusAns1: {
      ...
      set(value) {
        ...
        this.GetHealthPostData.QusAns[0].Answar = (value === 'true')
      }
    },
    // 請問您是否已投保其他商業實支實付型醫療保險?
    QusAns2: {
      ...
      set(value) {
        ...
        this.GetHealthPostData.QusAns[1].Answar = (value === 'true')
      }
    },
    // 被保險人目前是否受有監護宣告?
    QusAns3: {
      ...
      set(value) {
        ...
        this.GetHealthPostData.QusAns[2].Answar = (value === 'true')
        this.GetHealthPostData.AuthorizedRep = (value === 'true')
      }
    },
    // 最近二個月內是否曾因受傷或生病接受醫師治療、診療或用藥？
    QusAns4: {
      ...
      set(value) {
        ...
        this.GetHealthPostData.QusAns[3].Answar = (value === 'true')
      }
    },
    // 過去一年內是否曾因患有下列疾病，而接受醫師治療、診療或用藥? (有任一者，請選擇”是”)
    QusAns5: {
      get() {
      ...
      set(value) {
        ...
        this.GetHealthPostData.QusAns[4].Answar = (value === 'true')
      }
    },
    // 過去二年內是否曾因接受健康檢查有異常情形而被建議接受其他檢查或治療?
    QusAns6: {
      ...
      set(value) {
        ...
        this.GetHealthPostData.QusAns[5].Answar = (value === 'true')
      }
    },
    // 過去五年內是否曾因患有下列疾病，而接受醫師治療、診療或用藥? (有任一者，請選擇”是”)
    QusAns7: {
      get() {
      ...
      set(value) {
        ...
        this.GetHealthPostData.QusAns[6].Answar = (value === 'true')
      }
    },
    // 過去五年內，是否曾因受傷或生病住院治療七日以上？
    QusAns8: {
      ...
      set(value) {
        ...
        this.GetHealthPostData.QusAns[7].Answar = (value === 'true')
      }
    },
    // 目前身體機能狀況是否有失明、聾啞及言語、咀嚼、四肢機能障害、智能障礙（外表無法明顯判斷者）？
    QusAns9: {
      get() {
        return this.isShowAns9Error
      },
      set(value) {
        this.isShowAns9Error = value === 'true'
        this.GetHealthPostData.QusAns[8].Answar = (value === 'true')
      }
    },
    // 投保健康險者請繼續填寫本項： (有任一者，請選擇”是”)
    QusAns10: {
      get() {
        return this.isShowAns10Error
      },
      set(value) {
        this.isShowAns10Error = value === 'true'
        this.GetHealthPostData.QusAns[9].Answar = (value === 'true')
      }
    },
    // 您的職業類別
    jobCode: {
