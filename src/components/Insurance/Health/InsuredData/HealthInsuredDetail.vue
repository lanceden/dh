  ...
  <div>
    <div class="bg-radius">
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="form-control insure-input-block">{{GetHealthPostData.VerifyType}}</div>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetHealthPostData.address_M}}</div>
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-12 col-form-label insure-label">總保險費</label>
          <div class="col-sm-12">
            <div class="insure-input-block">NT$ {{GetHealthPostData.objAccident[0].mode_prem|decimalComma}} </div>
          </div>
        </div>
      </form>
    </div>
    <div class="bg-radius">
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetHealthPostData.objAccident[0].plan_title}}</div>
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-12 col-form-label insure-label">保額</label>
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetHealthPostData.objAccident[0].face_amt}} 元</div>
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-12 col-form-label insure-label">投保始期(保單生效日)</label>
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetHealthPostData.objAccident[0].po_issue_date_name}}</div>
            <div class="insure-input-block">至{{GetHealthPostData.objAccident[0].expired_date_name}}</div>
    ...
    <div class="bg-radius">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">同一次住院期間，憑收據正本於{{GetHealthPostData.objAccident[0].face_amt}}元內實</div>
    ...
    <div class="bg-radius">
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetHealthPostData.client_name}}(要被保人須為同一人)</div>
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-12 col-form-label insure-label">出生日期</label>
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetHealthPostData.client_birth_name}}</div>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">電話：{{GetHealthPostData.phoneH}}</div>
            <div class="insure-input-block">手機：{{GetHealthPostData.MobilePhone}}</div>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetHealthPostData.address_1}}</div>
          </div>
        </div>
      </form>
    </div>
    <div class="bg-radius">
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetHealthPostData.occupation_class_name}} {{GetHealthPostData.occupation_class_code_name}}</div>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="insure-text insure-text-explan">
            <ul class="insure-text-explancontent">
              <li class="decimal first">酒精或藥物濫用成癮、眩暈症。
              </li>
        ...
        <div class="border-bottom-line col-sm-12"></div>
        <div class="form-group row">
          <label for="" class="col-sm-12 col-form-label insure-label insure-label">過去五年內是否曾因患有下列疾病，而接受 醫師治療、診療或用藥？(有任一者，請選擇 “是”)</label>
          <div class="col-sm-12">
            <div class="insure-input-block">否</div>
          </div>
          <div class="border-bottom-line col-sm-12"></div>
        ...
        <div class="form-group row">
          ...
          <div class="insure-text insure-text-explan">
            <ul class="insure-text-explancontent">
              <li class="decimal first">現在是否仍患有下列疾病？精神官能症、何杰金氏症、膽管炎、膽囊炎、梅毒、腦性麻痺、腦膿瘍、化膿性骨髓炎、併發有嘔吐現象的持續性頭痛、內耳炎、鼻竇炎、乳突炎、坐骨神經痛、椎間板脫出、腎結石、輸尿管結石、膀胱結石、腦膜炎、腦炎、水腦症。
              </li>
              <li class="decimal">是否曾金屬中毒、化學中毒或施行剖腹生產？</li>
            </ul>
          </div>
        </div>
      </form>
    ...
    <div class="bg-radius">
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block" v-show="parseInt(GetHealthPostData.client_marriage) === 1">未婚</div>
            <div class="insure-input-block" v-show="parseInt(GetHealthPostData.client_marriage) === 2">已婚</div>
            <div class="insure-input-block" v-show="parseInt(GetHealthPostData.client_marriage) === 3">離婚</div>
            <div class="insure-input-block" v-show="parseInt(GetHealthPostData.client_marriage) === 4">喪偶</div>
            <div class="insure-input-block" v-show="parseInt(GetHealthPostData.client_marriage) === 5">分居</div>
            <div class="insure-input-block" v-show="parseInt(GetHealthPostData.client_marriage) === 6">其他</div>
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-12 col-form-label insure-label insure-label">身高</label>
          <div class="col-sm-9">
            <div class="insure-input-block">{{GetHealthPostData.client_height}}</div>
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <div class="insure-input-block">{{GetHealthPostData.client_weight}}</div>
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">
              <span v-show="GetHealthPostData.visit_time1 === true">早上9點~12點</span>
              <span v-show="GetHealthPostData.visit_time2 === true">下午1點～6點</span>
              <span v-show="GetHealthPostData.visit_time3 === true">晚上6點~9點</span>
            </div>
          </div>
        </div>
        <div class="col-sm-12">
...
export default {
  ...
  mounted () {
    ...
    axios.post('https://onlinetest.skl.com.tw/InsuranceWebApi/Customer/OrderDetail', jsonStr, yourConfig).then(response => {
      ...
      this.GetHealthPostData = response.data.Data.Result
      this.test()
    })
  }
}
