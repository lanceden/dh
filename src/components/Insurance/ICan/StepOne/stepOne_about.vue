      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12 insure-select-align">
            <select class="form-control data-input insure-select insure-input-block-edit" id="client_occupation_class" v-model="client_occupation_class" name="client_occupation_class">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12 insure-select-align">
            <select class="form-control data-input insure-select insure-input-block-edit" v-model="insure_peer_plan_1">
              <option value="0">請選擇</option>
              <option value="true">是</option>
              <option value="false">否</option>
            </select>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12 insure-select-align">
            <select class="form-control data-input insure-select insure-input-block-edit" v-model="QusAns4" @change="debugPrint()">
              <option value="0">請選擇</option>
              <option value="true">是</option>
              <option value="false">否</option>
            </select>
...
export default {
  ...
  computed: {
    ...
    client_occupation_class: {
      get() {
        return this.GetICanPostData.client_occupation_class || '0'
      },
      set(value) {
    ...
    insure_peer_plan_1: {
      get() {
        return this.GetICanPostData.insure_peer_plan_1 || false
      },
      set(value) {
        this.GetICanPostData.insure_peer_plan_1 = value ? 'Y' : 'N'
      }
    },
    // 請問您是否領有身心障礙手冊或身心障礙證明
    QusAns1: {
    ...
    QusAns2: {
      get() {
        return this.GetICanPostData.QusAns[1] || false
      },
      set(value) {
        this.GetICanPostData.QusAns[1] = value
      }
    },
    // 請問您過去二年內是否曾因患有下列疾病而接受醫師治療、診療或用藥? (有任一者，請選擇”是”)
    QusAns3: {
      get() {
        return this.GetICanPostData.QusAns[2] || false
      },
      set(value) {
        this.GetICanPostData.QusAns[2] = value
      }
    },
    // 請問您目前身體機能是否有下列障害：(有任一者，請選擇”是”)
    QusAns4: {
      get() {
        return this.GetICanPostData.QusAns[3] || false
      },
      set(value) {
        this.GetICanPostData.QusAns[3] = value
      }
    }
  },
  methods: {
