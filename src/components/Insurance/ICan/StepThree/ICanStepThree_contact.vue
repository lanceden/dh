    ...
    <div class="top">
      ...
      <form class="form-bottom">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <input type="text" class="form-control insure-input" :value="GetICanPostData.InsAddress" :disabled="!GetContactCheckBox">
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <input type="text" class="form-control insure-input-block" :disabled="GetContactCheckBox" placeholder="為保障您的權益，此欄位不可為空白" :value="GetICanPostData.address2">
          </div>
          <div :class="{checkbox: true, checked: !GetContactCheckBox}" @click="OnRegisterAddr()"></div>
        </div>
        <div class="col-sm-12">
  ...
  methods: {
    OnRegisterAddr() {
      ...
      if (!result) {
        ...
        /**
            // 戶籍地址
            var city2 = $("#ICanRegisteredCity").val();
            var district = $("#ICanRegisteredCounty").val();
            var zip2 = district.length > 0 ? district.substring(0, 3) : "";
            var district2 = district.length > 3 ? district.substring(3) : "";
            var road2 = $("#ICanRegisteredRoad").val();
             */
      }
