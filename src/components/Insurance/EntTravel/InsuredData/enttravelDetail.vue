  ...
  <div class="">
    <div class="bg-radius">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetEntTravelPostData.VerifyType}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for="" class="col-sm-12 col-form-label insure-label">保單形式</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{parseInt(GetEntTravelPostData.MAIL_TYPE) === 2 ? '電子保單' : '紙本保單'}}</div>
        </div>
      </div>

      <div class="border-bottom-line"></div>
      <div class="form-group row" v-show="parseInt(GetEntTravelPostData.MAIL_TYPE) === 1">
        <label for="" class="col-sm-12 col-form-label insure-label">保險單寄送地址</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetEntTravelPostData.INSURED_DATA[0].ADD_BEN_DEATH}}</div>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetEntTravelPostData.EMAIL}}</div>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetEntTravelPostData.PHONE}}</div>
        </div>
      </div>

      <div v-for="(item, index) in GetEntTravelPostData.INSURED_DATA" :key="index">
        <div class="form-group row">
    ...
    <div class="bg-radius">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetEntTravelPostData.PLAN_TITLE}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for="" class="col-sm-12 col-form-label insure-label">旅遊地點</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetEntTravelPostData.TRAVEL_Name}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for="" class="col-sm-12 col-form-label insure-label">投保始期</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetEntTravelPostData.PO_ISSUE_DATE}}</div>
          <div class="form-control insure-input-block">共{{GetEntTravelPostData.ISSUED_DAYS}}天</div>
        </div>
      </div>
    </div>

    <div class="bg-radius" v-for="(item, index) in GetEntTravelPostData.INSURED_DATA" :key="index">
      <div class="top">
        <div class="top-title">
          <div class="insure-notice-box">
            <div class="insure-check"><img src="../../../../../static/img/checkmark.png" alt=""></div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{item.BIRTH_BEN_DEATH}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for="" class="col-sm-12 col-form-label insure-label">身份證字號</label>
    ...
    <div class="bg-radius">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetEntTravelPostData.EMER_NAME}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for="" class="col-sm-12 col-form-label insure-label">電話</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetEntTravelPostData.EMER_PHONE}}</div>
        </div>
      </div>
      <div class="form-group row">
...
export default {
  ...
  mounted () {
    ...
    axios.post('https://onlinetest.skl.com.tw/InsuranceWebApi/Customer/OrderDetail', test, yourConfig).then(response => {
      ...
      this.GetEntTravelPostData = response.data.Data.Result
    })
  },
  methods: {
  }
