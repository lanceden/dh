<template>
  <div>
    <div class="bg-radius">
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="form-control insure-input" >{{GetUpCashPostData.phone_mobile}}</div>
          </div>
        </div>
        <div class="col-sm-12">
    ...
    <div class="bg-radius">
      ...
      <div class="border-bottom-line"></div>
      <!-- 戶籍地址 -->
      <RegisterAddressComponent :stateData="GetUpCashPostData"></RegisterAddressComponent>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    phone_ext: {
      get() {
        return this.GetUpCashPostData.phone_ext
      },
      set(value) {
        this.GetUpCashPostData.phone_ext = value
      }
    },
    // 電子郵件
    email: {
