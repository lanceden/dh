        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">
              ...
              <span v-show="parseInt(GetUpCashPostData.visit_time1) === 1 && parseInt(GetUpCashPostData.visit_time2) === 1">,</span>
              <span v-show="parseInt(GetUpCashPostData.visit_time2) === 1">下午1點～6點</span>
              <span v-show="parseInt(GetUpCashPostData.visit_time2) === 1 && parseInt(GetUpCashPostData.visit_time3) === 1">,</span>
