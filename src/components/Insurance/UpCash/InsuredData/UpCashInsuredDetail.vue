  ...
  <div>
    <div class="bg-radius">
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="form-control insure-input-block">{{GetUpCashPostData.VerifyType}}</div>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetUpCashPostData.address_M}}</div>
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-12 col-form-label insure-label">第一期應繳保險費</label>
          <div class="col-sm-12">
            <div class="insure-input-block">NT$ {{GetUpCashPostData.objAccident[0].mode_prem|decimalComma}} </div>
          </div>
        </div>
      </form>
    </div>
    ...
    <div class="bg-radius">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="insure-input-block">{{GetUpCashPostData.objAccident[0].plan_title}}</div>
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="insure-input-block">保險年齡：{{GetUpCashPostData.objAccident[0].fst_anny_pay_age}}歲之保單週年日</div>
        </div>
      </div>
      <div class="form-group row">
        <label for="" class="col-sm-12 col-form-label insure-label">年金給付方式</label>
        <div class="col-sm-12">
          <div class="insure-input-block">{{GetUpCashPostData.objAccident[0].anny_frequence === '0' ? '一次給付' : '分期給付'}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for="" class="col-sm-12 col-form-label insure-label">保價金通知方式</label>
        <!-- 電子郵件 -->
        <div class="col-sm-12" v-show="GetUpCashPostData.objAccident[0].value_ind === '4'">
          <div class="insure-input-block">{{GetUpCashPostData.objAccident[0].address3}}</div>
        </div>
        <!-- 寄送到客戶住所(通訊地址) -->
        <div class="col-sm-12" v-show="GetUpCashPostData.objAccident[0].value_ind === '1'">
          <div class="insure-input-block">{{GetUpCashPostData.address_M}}</div>
        </div>
      </div>
    </div>
    <div class="bg-radius">
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetUpCashPostData.client_name}}</div>
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-12 col-form-label insure-label">出生日期</label>
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetUpCashPostData.client_birth_name}}</div>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">電話：{{GetUpCashPostData.phoneH}}
              <br>手機：{{GetUpCashPostData.MobilePhone}}</div>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetUpCashPostData.address_1}}</div>
          </div>
        </div>
      </form>
    </div>
    <div class="bg-radius" v-for="(item, index) in GetUpCashPostData.BenfList" :key="index">
      <div class="top">
        <div class="top-title">
          <div class="insure-notice-box">
            <div class="insure-check"><img src="../../../../../static/img/checkmark.png" alt=""></div>
    ...
    <div class="bg-radius">
      ...
      <form class="form-bottom">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetUpCashPostData.occupation_class_name}} {{GetUpCashPostData.occupation_desc}}</div>
          </div>
        </div>
        <div class="form-group row">
    ...
    <div class="bg-radius">
      ...
      <form class="form-bottom">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetUpCashPostData.objAccident[0].CRSData.birth_national}}</div>
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-12 col-form-label insure-label">出生地-城市</label>
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetUpCashPostData.objAccident[0].CRSData.birth_city}}</div>
          </div>
        </div>
      </form>
    </div>
    ...
    <div class="bg-radius">
      ...
      <form class="form-bottom">
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetUpCashPostData.objAccident[0].AccountData[2].bank_code_1}}</div>
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-12 col-form-label insure-label insure-label">金融機構中文名稱</label>
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetUpCashPostData.objAccident[0].AccountData[2].bank_name_1}}</div>
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-12 col-form-label insure-label insure-label">銀行帳號</label>
          <div class="col-sm-12">
            <div class="insure-input-block">{{GetUpCashPostData.objAccident[0].AccountData[2].account}}</div>
          </div>
        </div>
      </form>
    </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <div class="insure-input-block">
              <span v-show="GetUpCashPostData.visit_time1 === true">早上9點~12點</span>
              <span v-show="GetUpCashPostData.visit_time2 === true">下午1點～6點</span>
              <span v-show="GetUpCashPostData.visit_time3 === true">晚上6點~9點</span>
            </div>
          </div>
        </div>
        <div class="col-sm-12">
...
export default {
  ...
  mounted () {
    ...
    axios.post('https://onlinetest.skl.com.tw/InsuranceWebApi/Customer/OrderDetail', jsonStr, yourConfig).then(response => {
      ...
      this.GetUpCashPostData = response.data.Data.Result
      this.test()
    })
  },
  computed: {
