  ...
  <div class="">
    <div class="bg-radius">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{stateData.PolicyData.InsTypeDisplay}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for="" class="col-sm-12 col-form-label insure-label">保單形式</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{parseInt(stateData.PolicyData.MailType) === 2 ? '電子保單' : '紙本保單'}}</div>
        </div>
      </div>

      <div class="border-bottom-line"></div>
      <div class="form-group row" v-show="parseInt(stateData.PolicyData.MailType) === 1">
        <label for="" class="col-sm-12 col-form-label insure-label">保險單寄送地址</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{stateData.PolicyData.ProposerInfo[0].MailingAddr.Address}}</div>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{stateData.PolicyData.ProposerInfo[0].Email}}</div>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{stateData.PolicyData.ProposerInfo[0].Phone}}</div>
        </div>
      </div>

      <div v-for="(item, index) in stateData.PolicyData.InsuredInfo" :key="index">
        <div class="form-group row">
        ...
        <div class="form-group row" v-show="parseInt(stateData.PolicyData.TravelType) === 2">
          <label for="" class="col-sm-12 col-form-label insure-label">海外突發疾病醫療保險金限額</label>
          <div class="col-sm-12">
            <div class="form-control insure-input-block">{{item.SupplementPolicy[1].FaceAmt === null ? 0 : item.SupplementPolicy[1].FaceAmt}} 萬元</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-radius">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{stateData.InsuranceName}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for="" class="col-sm-12 col-form-label insure-label">旅遊地點</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{stateData.PolicyData.TravelPlaceDisplay}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for="" class="col-sm-12 col-form-label insure-label">投保始期</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{stateData.PolicyData.InsStartDisplay}}</div>
          <div class="form-control insure-input-block">{{stateData.PolicyData.InsEndDisplay}} 止，共{{stateData.PolicyData.TravelDay}}天</div>
        </div>
      </div>
    </div>

    <div class="bg-radius" v-for="(item, index) in stateData.PolicyData.InsuredInfo" :key="index">
      <div class="top">
        <div class="top-title">
          <div class="insure-notice-box">
            <div class="insure-check"><img src="../../../../static/img/notepad.png" alt=""></div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block" v-show="parseInt(item.Relation) === 1">{{item.PersonalData.Name}} (本人)</div>
          <div class="form-control insure-input-block" v-show="parseInt(item.Relation) !== 1">{{item.PersonalData.Name}} (子女)</div>
        </div>
      </div>
      <div class="form-group row">
    ...
    <div class="bg-radius">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{stateData.PolicyData.EmergencyContactName}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for="" class="col-sm-12 col-form-label insure-label">電話</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{stateData.PolicyData.EmergencyContactTel}}</div>
        </div>
      </div>
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">
            {{stateData.PolicyData.EmergencyContactAddr.City}}
            {{stateData.PolicyData.EmergencyContactAddr.District}}
            {{stateData.PolicyData.EmergencyContactAddr.Street}}
          </div>
        </div>
      </div>
    </div>
