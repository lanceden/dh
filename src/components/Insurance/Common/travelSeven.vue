...
export default {
  ...
  mounted() {
    ...
    if (this.stateData.PolicyData.EmergencyContactAddr === null) {
      ...
      // 暫存舊的通訊地址
      this.tempCity2 = this.stateData.PolicyData.EmergencyContactAddr.City
      this.tempDistrict2 = this.stateData.PolicyData.EmergencyContactAddr.District
      this.tempRoad2 = this.stateData.PolicyData.EmergencyContactAddr.Street
    }
  },
  watch: {
  ...
  computed: {
    ...
    EmergencyContactName: {
      get() {
        return this.stateData.PolicyData.EmergencyContactName
      },
      set(value) {
        this.stateData.PolicyData.EmergencyContactName = value
      }
    },
    // 緊急聯絡人電話
    EmergencyContactTel: {
      get() {
        return this.stateData.PolicyData.EmergencyContactTel
      },
      set(value) {
        this.stateData.PolicyData.EmergencyContactTel = value
      }
    },
    // 緊急聯絡人地址-縣市
    EmergencyContactAddrCity: {
      get() {
        if (!this.stateData.PolicyData.EmergencyContactAddr) {
          this.stateData.PolicyData.EmergencyContactAddr = {
            City: '',
            District: '',
            Street: ''
        ...
        return this.stateData.PolicyData.EmergencyContactAddr.City || 0
      },
      set(value) {
        this.stateData.PolicyData.EmergencyContactAddr.City = value
        this.stateData.PolicyData.EmergencyContactAddr.District = 0
      }
    },
    // 緊急聯絡人地址-區域
    EmergencyContactAddrDistrict: {
      get() {
        if (this.stateData.PolicyData.EmergencyContactAddr.District === 0) return 0
        return (`${this.stateData.PolicyData.EmergencyContactAddr.District}`) || 0
      },
      set(value) {
        // item.Zip|item.Area
        this.stateData.PolicyData.EmergencyContactAddr.District = value
      }
    },
    // 緊急聯絡人地址-路
    EmergencyContactAddrStreet: {
      get() {
        return this.stateData.PolicyData.EmergencyContactAddr.Street
      },
      set(value) {
        this.stateData.PolicyData.EmergencyContactAddr.Street = value
      }
    }
  },
  methods: {
