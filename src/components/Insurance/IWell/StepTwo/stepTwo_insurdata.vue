...
export default {
  ...
  computed: {
    ...
    po_issue_date: {
      get() {
        return this.GetIWellPostData.po_issue_date || moment().add(`1`, 'days').format(`YYYY-MM-DD`)
      },
      set(value) {
    ...
    TrvDays: {
      get() {
        return this.GetIWellPostData.TrvDays || 30
      },
      set(value) {
    ...
    face_amt: {
      get() {
        return this.GetIWellPostData.face_amt || 400
      },
      set(value) {
