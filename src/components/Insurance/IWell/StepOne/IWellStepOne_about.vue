    ...
    OnEnsure(target, value) {
      switch (target) {
        ...
        case 'QusAns1':
          ...
          this.GetIWellPostData.QusAns[0].Answar = value
          break
          // 請問您是否已投保其他商業實支實付型傷害醫療保險
        case 'QusAns2':
          if (value) {
          ...
          this.GetIWellPostData.QusAns[1].Answar = value
          break
          // 被保險人目前是否受有監護宣告
        case 'QusAns3':
          if (value) {
          ...
          this.GetIWellPostData.AuthorizedRep = value
          this.GetIWellPostData.QusAns[2].Answar = value
          break
        ...
        case 'QusAns4':
          ...
          this.GetIWellPostData.QusAns[3].Answar = value
          break
        ...
        case 'QusAns5':
          ...
          this.GetIWellPostData.QusAns[4].Answar = value
          break
      }
    },
    // 顯示職業類別說明
