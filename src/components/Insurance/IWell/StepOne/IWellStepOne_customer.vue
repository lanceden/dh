  ...
  <div class="bg-radius">
    ...
    <form class="form-bottom">
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetIWellPostData.client_names}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for class="col-sm-12 col-form-label insure-label">被保險人出生年月日</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetIWellPostData.Birthday_Full}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for class="col-sm-12 col-form-label insure-label">被保險人身分證字號</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetIWellPostData.client_id}}</div>
        </div>
      </div>
      <div class="form-group row">
        <label for class="col-sm-12 col-form-label insure-label">被保險人性別</label>
        <div class="col-sm-12">
          <div class="form-control insure-input-block">{{GetIWellPostData.client_rate_sex === 1 ? '男性' : '女性'}}</div>
        </div>
      </div>
