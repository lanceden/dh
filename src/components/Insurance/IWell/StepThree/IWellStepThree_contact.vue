    ...
    <div class="top">
      ...
      <form class="form-bottom">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-12">
            <input type="text" class="form-control insure-input" :value="GetIWellPostData.address1" :disabled="!GetContactCheckBox">
          </div>
  ...
  methods: {
    OnRegisterAddr() {
      ...
      if (!result) {
        ...
        /**
            // 戶籍地址
            var city2 = $("#IWellRegisteredCity").val();
            var district = $("#IWellRegisteredCounty").val();
            var zip2 = district.length > 0 ? district.substring(0, 3) : "";
            var district2 = district.length > 3 ? district.substring(3) : "";
            var road2 = $("#IWellRegisteredRoad").val();
             */
      }
