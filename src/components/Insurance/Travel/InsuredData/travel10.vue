<template>
  <div class="">
    <div class="bg-radius">
      ...
      <div class="border-bottom-line"></div>
      <div class="bg-money bg-money-twoline" v-show="parseInt(this.GetTravelPostData.PolicyData.MailType) === 1">
        <div class="left font-label dib col-sm-3">
          保險單寄送地址
        </div>
        <div class="content font-label dib col-sm-9">
          台北市松山區敦化北路102號B1樓
        </div>
      </div>
