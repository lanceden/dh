  ...
  computed: {
    ...
    PrimaryPolicyFaceAmtOne: {
      ...
      set(value) {
        ...
        this.$store.state.Travel.TRAVELPOSTDATA.PolicyData.InsuredInfo[this.index].SupplementPolicy[this.index].FaceAmt = parseInt(value.toString().substring(0, 1) + '0')
    ...
    SupplementPolicyFaceAmtoOverSea: {
      get() {
        return this.$store.state.Travel.TRAVELPOSTDATA.PolicyData.InsuredInfo[this.index].SupplementPolicy[1].FaceAmt || 80
      },
      set(value) {
        if (this.$store.state.Travel.TRAVELPOSTDATA.PolicyData.TravelType === 2 && this.$store.state.Travel.TRAVELPOSTDATA.PolicyData.TravelCountry === '7') {
          this.$store.state.Travel.TRAVELPOSTDATA.PolicyData.InsuredInfo[this.index].SupplementPolicy[1].FaceAmt = value
        } else {
          this.$store.state.Travel.TRAVELPOSTDATA.PolicyData.InsuredInfo[this.index].SupplementPolicy[1].FaceAmt = null
        }
      }
    }
  }
