  ...
  <div class="bg-radius">
    ...
    <form class="form-bottom">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <input type="text" class="form-control insure-input-block" disabled="disabled" :value="this.GetTravelPostData.length === 0 ? '' : this.GetTravelPostData.PolicyData.ProposerInfo[0].Name">
        </div>
      </div>
      <!-- 要保險人身分證字號 -->
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <input type="text" class="form-control insure-input-block" disabled="disabled" :value="this.GetTravelPostData.length === 0 ? '' : this.GetTravelPostData.PolicyData.ProposerInfo[0].ID">
        </div>
      </div>
      <!-- 要保險人性別 -->
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <input type="text" class="form-control insure-input-block" disabled="disabled" :value="this.GetTravelPostData.length === 0 ? '' : this.GetTravelPostData.PolicyData.ProposerInfo[0].Gender === '1' ? '男' : '女'">
        </div>
      </div>
    </form>
    <!-- 請確認保障對象 -->
