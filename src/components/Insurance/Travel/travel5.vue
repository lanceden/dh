  ...
  <div>
    <div class="container">
      ...
      <div class="progress-bar">
        <img src="images/progress-bar-06-3.png">
      </div>
      <div class="bg-radius">
        <div class="top">
          <div class="top-title">
            <div class="insure-notice-box">
              <div class="insure-check"><img src="images/mail.png" alt=""></div>
        ...
        <form class="form-bottom">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-12 insure-select-align">
              <input type="text" class="form-control insure-input insure-input-edit" id="" placeholder="" value="請填寫受益人姓名">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-12 insure-select-align">
              <input type="text" class="form-control insure-input insure-input-edit" id="" placeholder="" value="請填寫身分證字號">
            </div>
          </div>
          <div class="form-group row">
            <label for="" class="col-sm-12 col-form-label insure-label">聯絡電話</label>
            <div class="col-sm-12 insure-select-align">
              <input type="text" class="form-control insure-input insure-input-edit" id="" placeholder="" value="請填寫聯絡電話">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-12 insure-select-align">
              <input type="text" class="form-control insure-input insure-input-edit" id="" placeholder="" value="請填寫詳細地址">
            </div>
          </div>
          <div class="form-group posr row">
