...
export default {
  ...
  computed: {
    ...
    phone_ext: {
      get() {
        return this.GetAccidentPostData.phone_ext
      },
      set(value) {
        this.GetAccidentPostData.phone_ext = value
      }
    },
    // 電子郵件
    email: {
      get() {
        return this.GetAccidentPostData.email
      },
      set(value) {
        this.GetAccidentPostData.email = value
      }
    }
  }
}
