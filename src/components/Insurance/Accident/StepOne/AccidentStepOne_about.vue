  ...
  computed: {
    ...
    QusAns1: {
      ...
      set(value) {
        ...
        this.GetAccidentPostData.QusAns[0].Answar = (value === 'true')
      }
    },
    // 被保險人目前是否受有監護宣告?
    QusAns2: {
      ...
      set(value) {
        ...
        this.GetAccidentPostData.QusAns[1].Answar = (value === 'true')
        this.GetAccidentPostData.AuthorizedRep = (value === 'true')
      }
    },
    // 請問您過去二年內是否曾因患有下列疾病而接受醫師治療、診療或用藥? (有任一者，請選擇”是”)
    QusAns3: {
      ...
      set(value) {
        ...
        this.GetAccidentPostData.QusAns[2].Answar = (value === 'true')
      }
    },
    // 請問您目前身體機能是否有下列障害：(有任一者，請選擇”是”)
    QusAns4: {
      ...
      set(value) {
        ...
        this.GetAccidentPostData.QusAns[3].Answar = (value === 'true')
      }
    }
  }
}
