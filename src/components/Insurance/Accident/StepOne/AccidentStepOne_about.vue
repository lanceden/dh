  ...
  <div class="bg-radius">
    ...
    <form class="form-bottom">
      ...
      <div class="form-group row">
        ...
        <div class="border-bottom-line col-sm-12"></div>
        <label v-show="isShowAns4Error === true" class="col-sm-12 col-form-label insure-label text-with-select">親愛的客戶謝謝您的申購保險，因相關法規
          規定您的申請文件需另檢附相關證明文件。
          很抱歉您無法於本網站進行投保動作。煩請
          另洽新光人壽服務人員詢問相關保險商品購
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-12 insure-select-align">
        <select id="" class="form-control data-input insure-select insure-input-block-edit" id="client_occupation_class" v-model="client_occupation_class_computed" name="client_occupation_class">
      ...
      <div class="border-bottom-line col-sm-12"></div>
      <form class="form-bottom">
        <div class="col-sm-12" @click='OnShowOccupation()'>
