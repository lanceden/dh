  ...
  <div class="bg-radius">
    ...
    <form class="form-bottom">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-12">
          <input type="text" class="form-control insure-input" id="txtOldAddress2" :value="GetIGoingPostData.address2" disabled="disabled">
...
export default {
  ...
  mounted() {
    // 暫存舊的通訊地址
    this.tempZip2 = this.GetIGoingPostData.zip2
    this.tempCity2 = this.GetIGoingPostData.city2
    this.tempDistrict2 = this.GetIGoingPostData.district2
    this.tempRoad2 = this.GetIGoingPostData.road2
  },
  computed: {
    ...mapGetters([
      'GetCityData',
    ...
    phone_area: {
      get() {
        return this.GetIGoingPostData.phone_area || ''
      },
      set(value) {
        this.GetIGoingPostData.phone_area = value
      }
    },
    // 電話
    phone_main: {
      get() {
        return this.GetIGoingPostData.phone_main || ''
      },
      set(value) {
        this.GetIGoingPostData.phone_main = value
      }
    },
    // 輸入新的戶籍地址-縣市
    city2: {
      get() {
        return this.GetIGoingPostData.city2 || '0'
      },
      set(value) {
        this.GetIGoingPostData.city2 = value
        // 重新選取縣市, 要更新區域下拉框並清空區域原先的值
        this.FuncGetDistrictData(value)
        this.GetIGoingPostData.district2 = 0
      }
    },
    // 輸入新的戶籍地址-區域
    district2: {
      get() {
        let result = InitColumnData(this.GetIGoingPostData.district2, '0')
        if (result === '0') return '0'
        return (`${this.GetIGoingPostData.zip2}-${this.GetIGoingPostData.district2}`) || 0
      },
      set(value) {
        // item.Zip|item.Area
        let data = value.split('-')
        this.GetIGoingPostData.zip2 = data[0]
        this.GetIGoingPostData.district2 = data[1]
      }
    },
    // 輸入新的戶籍地址-路
    road2: {
      get() {
        return this.GetIGoingPostData.road2
      },
      set(value) {
        this.GetIGoingPostData.road2 = value
      }
    }
  },
  methods: {
    ...
    OnRegisterAddr(target) {
      switch (target) {
        case 'old':
          ...
          this.GetIGoingPostData.zip2 = this.tempZip2
          this.GetIGoingPostData.city2 = this.tempCity2
          this.GetIGoingPostData.district2 = this.tempDistrict2
          this.GetIGoingPostData.road2 = this.tempRoad2
          break
        case 'new':
