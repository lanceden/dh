      ...
      <div class="bg-radius">
        ...
        <div class="bg-time">
          <div class="col-sm-12">
            ...
            <div class="font-label text-red-i">自民國 {{GetIGoingPostData.po_issue_date_Name}} 午夜十二時起</div>
            <div class="font-label text-red-i">至民國 {{GetIGoingPostData.matured_date_Name}} 午夜十二時止</div>
          </div>
        </div>
      </div>
