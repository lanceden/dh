  ...
  <div class="bg-radius">
    ...
    <form class="form-bottom">
      ...
      <div class="form-group row" v-show="relation_ben_death !== '8'">
        ...
        <div class="col-sm-12 insure-select-align">
          <input type="number" class="form-control insure-input-block" placeholder="請填寫" v-model="relation_ben_death_seq_percent">
        </div>
      </div>
      <div class="form-group row" v-show="relation_ben_death !== '8'">
      ...
      <div class="form-group row" v-show="relation_ben_death !== '8'">
        ...
        <div class="col-sm-12 insure-select-align">
          <input type="text" class="form-control insure-input insure-input-edit" placeholder="請填寫" v-model="benf_phone" />
        </div>
      </div>
      <div class="form-group row" v-show="relation_ben_death !== '8'">
      ...
      <div class="form-group row" v-show="relation_ben_death !== '8'">
        ...
        <div class="col-sm-12 insure-select-align">
          <input type="text" class="form-control data-input insure-input-edit" placeholder="請填寫"  v-model="BenfAddRemain" />
        </div>
      </div>
    </form>
